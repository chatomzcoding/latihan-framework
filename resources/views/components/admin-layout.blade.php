...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/dashboard')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Latihan Framework</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info text-white pt-0">
          <span href="#" class="d-block text-capitalize">Admin <br> <small>admin 
          </small></span> 
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <a href="#">Sistem Informasi Website</a>.</strong>
    All rights reserved.
